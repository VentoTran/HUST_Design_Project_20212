...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED1_Pin|PCTRL0_Pin|PCTRL1_Pin|SPI1_CS_Pin
                          |CS_Pin|RS_Pin|WR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RD_Pin|RST_Pin, GPIO_PIN_RESET);
