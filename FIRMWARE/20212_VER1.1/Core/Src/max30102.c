...
void max30102_interrupt_handler(max30102_t *obj)
{
    ...
    max30102_read(obj, MAX30102_INTERRUPT_ENABLE_1, reg, 2);
...
{
    uint8_t val = 0x00;
    max30102_write(obj, MAX30102_FIFO_WR_PTR, (uint8_t*)&val, 1);
    max30102_write(obj, MAX30102_FIFO_RD_PTR, (uint8_t*)&val, 1);
    max30102_write(obj, MAX30102_OVF_COUNTER, (uint8_t*)&val, 1);
}
