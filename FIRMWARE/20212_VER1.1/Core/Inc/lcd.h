...
#if USE_DMA == 1
#define DISPLAY_EVENT_FLAG_DMA_DONE (0x01)
#endif  //  USE_DMA
...
void ILI9341_DrawBitmapDMA(uint16_t x0, uint16_t y0, uint16_t width, uint16_t height, uint8_t * pdata);


void Display_SetEventHandler(osEventFlagsId_t eventFlag);
